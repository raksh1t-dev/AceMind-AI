...
function TopicForm({ setResult, setLoading, loading, setError }) {
  ...
  const [noteStyle, setNoteStyle] = useState("exam");
...
<div className="mb-2">
  ...
  <p className="text-sm text-gray-500">
    Customize how AceMind generates your notes.
  </p>
</div>
...
text-gray-900
        focus:outline-none focus:ring-2 focus:ring-indigo-300' placeholder='Enter topic (e.g. Web Development)'
...
text-gray-900
  ...
  {[
    { key: "exam", label: "📝 Exam Notes" },
{ key: "revision", label: "⚡ Revision" },
{ key: "interview", label: "🎤 Viva Prep" },
{ key: "detailed", label: "📚 Deep Study" },
  ].map((style) => (
    <button
      key={style.key}
      type="button"
...
<h3 className="text-lg font-semibold text-gray-900">
  Additional Options
    ...
    ${loading
            ...
            :  "bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-[0_15px_35px_rgba(99,102,241,0.35)]"
          }
  `}>
        {loading ? "Generating Notes..." : "✨ Generate Smart Notes"}
